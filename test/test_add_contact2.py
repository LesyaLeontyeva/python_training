...
class test_add_contact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.add_new_contact(wd, Contact(firstname="olesya", lastname="leontyeva", nickname="lesya", title="qwerty", company="onlc", address="Lenina str, 49", home="Kazan",
                             mobile="89179043417", work="QA", fax="none", email="email1@mail.ru", email2="email2@mail.ru", email3="email3@mail.ru", byear="1992",
    ...
    def test_add__empty_contact(self):
        ...
        self.open_home_page(wd)
        self.login(wd, username="admin", password="secret")
        self.add_new_contact(wd, Contact(firstname="", lastname="", nickname="", title="", company="", address="", home="",
                             mobile="", work="", fax="", email="", email2="", email3="", byear="",
