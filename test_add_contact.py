...
class test_add_contact(unittest.TestCase):
    ...
    def test_test_add_contact(self):
        ...
        self.login(wd)
        self.new_contact_add_page(wd)
        self.fill_information_about_company(wd)
    ...
    def fill_information_about_company(self, wd):
        # Fill information about company
        wd.find_element_by_name("title").click()
        wd.find_element_by_name("title").clear()
        wd.find_element_by_name("title").send_keys("qwerty")
        wd.find_element_by_name("company").click()
        wd.find_element_by_name("company").clear()
        wd.find_element_by_name("company").send_keys("onlc")
        wd.find_element_by_name("address").click()
        wd.find_element_by_name("address").clear()
        wd.find_element_by_name("address").send_keys("Lenina str, 49")
        wd.find_element_by_name("home").click()
        wd.find_element_by_name("home").clear()
        wd.find_element_by_name("home").send_keys("Kazan")
        wd.find_element_by_name("mobile").click()
        wd.find_element_by_name("mobile").clear()
        wd.find_element_by_name("mobile").send_keys("89179043417")
        ...
        wd.find_element_by_name("address2").send_keys("Kazan,Lenina str,49")
        wd.find_element_by_name("phone2").click()
        wd.find_element_by_name("phone2").clear()
        wd.find_element_by_name("phone2").send_keys("Kazan")
        wd.find_element_by_name("notes").click()
        wd.find_element_by_name("notes").clear()
        wd.find_element_by_name("notes").send_keys("first test on Python")

    def new_contact_add_page(self, wd):
        ...
        wd.find_element_by_name("lastname").send_keys("leontyeva")
        wd.find_element_by_name("nickname").click()
        wd.find_element_by_name("nickname").clear()
        wd.find_element_by_name("nickname").send_keys("lesya")
